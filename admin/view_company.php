            ...
            <?php
                ...
                while($row = mysqli_fetch_assoc($result)){
                    echo '<tr>
                            ...
                            <td>'.$row['email'].'</td>
                            <td>
                                <button class="btn btn-success"><a href="update_company.php?id='.$row['comp_id'].'" class="text-white text-decoration-none">UPDATE</a></button>
                                <button class="btn btn-danger"><a href="delete_company.php?id='.$row['comp_id'].'" class="text-white text-decoration-none">DELETE</a></button>
